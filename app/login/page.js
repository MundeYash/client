...
export default function login() {
  return (
    <>
      ...
      <main className=" bg-blue-500 p-4 md:p-12">


        
        <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg overflow-hidden p-8">
         
            <section className="border-20">
              <div className="w-1/2 flex flex-col items-center justify-center bg-gray-100 pt-12 pr-12 pb-12 pl-12 border-r border-gray-300">
                <img
                  alt="Operator Icon"
                ...
                <Link
                  className="inline-flex items-center rounded-md bg-blue-500 px-6 py-3 text-lg font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-md"
                  href="/login/operator"
                >
                  <svg
            ...
            <section>
              ...
              <div className="w-1/2 flex flex-col items-center justify-center bg-[#5471d3] pt-12 pr-12 pb-12 pl-12 border-r border-gray-700">
                <img
                  alt="Admin Icon"
                  className="h-24 w-auto mb-4"
                ...
                <Link
                  className="inline-flex items-center rounded-md bg-gray-500 px-6 py-3 text-lg font-medium text-white hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 shadow-md"
                  href="/login/admin"
                >
                  <svg
                    className="h-6 w-6 mr-2"
